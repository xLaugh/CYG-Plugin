...
public class ShortcutSetSpawnCommand extends TCommand {

    public ShortcutSetSpawnCommand(CYG main) {
    ...
    public void onExecute(Player player, String[] args) {
        ...
        dataManager().setSpawn(player);
        player.sendMessage("Nouveau spawn placé pour le /plot !");
